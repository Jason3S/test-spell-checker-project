...
import { createPseudoTerminal } from './createPseudoTerminal';
...
export function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('terminalTest.createPseudoTerminal', () => {
            const terminal = createPseudoTerminal();
            terminal.show();
        })
    );
    context.subscriptions.push(
        vscode.commands.registerCommand('terminalTest.createTerminalHideFromUser', () => {
            vscode.window.createTerminal({
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('terminalTest.updateEnvironment', () => {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('terminalTest.onDidWriteTerminalData', () => {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('terminalTest.onDidChangeTerminalDimensions', () => {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('terminalTest.registerTerminalLinkProvider', () => {
